...
bool isNodePresent(BinaryTreeNode<int> *root, int x) {
    ...
    if(root->data==x){ // instead of looking at the left and right of root just look at the root's data
        return true;
    }
    ...
    ans = isNodePresent(root->right,x); // agar abhi bhi nahi mila toh ispe call karo
    }
    return ans;
}
